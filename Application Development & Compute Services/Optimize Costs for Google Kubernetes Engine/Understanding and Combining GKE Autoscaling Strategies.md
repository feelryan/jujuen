...
2. Run the following command to create a three node cluster in the us-east1-b zone:
...
Vertical Pod Autoscaling has already been enabled on the _scaling-demo_ cluster.
